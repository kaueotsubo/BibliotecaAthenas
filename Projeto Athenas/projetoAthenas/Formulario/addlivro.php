...
<html lang="en">
  ...
  <div class = "person"> <!-- COMEÇO DIV PESSOA LOGADA -->
    ...
    <div class = "icon-book"> <!-- DIV ICONE LIVRO -->
      <i class="bi bi-book"  style="font-size:300px"></i>
    </div> <!-- FIM DA DIV ICONE LIVRO -->

    <div class = "text2">
      Adicione ou arraste o arquivo de um livro em EPUB aqui.
    </div>

    <a href = "book/index.html">
      <div class = "button-add-file"> <!-- COMEÇO DIV BOTAO LOGIN -->
        <div class = "components">
